...
export function BrowseContainer({ slides }) {
    ...
    const [slideRows, setSlideRows] = useState([slides['series']]);
    ...
    useEffect(() => {
        ...
        if (setSlideRows.length > 0 && searchTerm.length > 3 && results.length > 0) {
        ...
        (
            <>
                ...
                <Header src="joker1">
                    <Header.Frame>
                        <Header.Group>
                            <Header.Logo to={ROUTES.HOME} src={logo} alt="Fletnix" />
                            <Header.TextLink
